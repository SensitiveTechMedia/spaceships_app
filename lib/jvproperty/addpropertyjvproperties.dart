...
class _CategoryScreenState extends State<JvAddProperty> {
  ...
  void initState() {
    super.initState();
    String mode = "Sell"; // Replace with your actual mode logic
    switch (mode) {
      case "Sell":
      case "Rent":
      case "Lease":
        subcategories = [
          {"name": "Flat", "category": "Property"},
          {"name": "Villa / Independent House", "category": "Property"},
          {"name": "Plot / Land", "category": "Property"},
          {"name": "Commercial Space", "category": "Property"},
          {"name": "Hostel/PG/Service Apartment", "category": "Property"},
        ];
        break;
      default:
        subcategories = [];
...
// Retrieve selected category when a subcategory is tapped
  void _onSubcategoryTap(int index) {
    ...
    String selectedCategory = subcategories[_selectedSubcategoryIndex]["category"];
