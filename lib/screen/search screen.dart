              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Viewage(propertyId: property.propertyId,)),
                    );
                  },
                );
              },
...
class Viewage extends StatelessWidget {
  final String propertyId;

  Viewage({required this.propertyId});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
        future: _fetchPropertyData(propertyId),
    builder: (context, snapshot) {
    if (snapshot.hasData) {
    PropertyModel property = snapshot.data as PropertyModel;
    return Padding(
    ...
    children: property.propertyImages.map((image) {
    ...
    ListTile(
    title: Text('Address Line: ${property.addressLine}'),
    ),
    ListTile(
    title: Text('Amenities: ${property.amenities.join(', ')}'),
    ),
    ListTile(
    title: Text('Area: ${property.area}'),
    ),
    ListTile(
    title: Text('Area Type: ${property.areaType}'),
    ),
    ListTile(
    title: Text('Balcony: ${property.balcony}'),
    ),
    ListTile(
    title: Text('Bathroom: ${property.bathroom}'),
    ),
    ListTile(
    title: Text('Bike Parking Count: ${property.bikeParkingCount}'),
    ),
    ListTile(
    title: Text('Car Parking Count: ${property.carParkingCount}'),
    ),
    ListTile(
    title: Text('Category: ${property.category}'),
    ),
    ListTile(
    title: Text('Dimension: ${property.dimension}'),
    ),
    ListTile(
    title: Text('Door No: ${property.doorNo}'),
    ),
    ListTile(
    title: Text('Featured Status: ${property.featuredStatus ? 'Yes' : 'No'}'),
    ),
    ListTile(
    title: Text('Floor Number: ${property.floorNumber}'),
    ),
    ListTile(
    title: Text('Floor Type: ${property.floorType}'),
    ),
    ListTile(
    title: Text('Furnishing Type: ${property.furnishingType}'),
    ),
    ListTile(
    title: Text('Is Corner Area: ${property.isCornerArea ? 'Yes' : 'No'}'),
    ),
    ListTile(
    title: Text('Landmark: ${property.landmark}'),
    ),
    ListTile(
    title: Text('Latitude: ${property.latitude}'),
    ),
    ListTile(
    title: Text('Location Address: ${property.locationAddress}'),
    ),
    ListTile(
    title: Text('Longitude: ${property.longitude}'),
    ),
    ListTile(
    ...
    itemBuilder: (context, index) {
    return ListTile(
    title: Text('Place: ${property.nearbyPlaces[index]['place']}'),
    subtitle: Text('Distance: ${property.nearbyPlaces[index]['distance']}'),
    );
    },
    ),
    ),
    ListTile(
    title: Text('Parking Included: ${property.parkingIncluded ? 'Yes' : 'No'}'),
    ),
    ListTile(
    title: Text('Parking Type: ${property.parkingType}'),
    ),
    ListTile(
    title: Text('Payment Rows:'),
    subtitle: ListView.builder(
    shrinkWrap: true,
    physics: NeverScrollableScrollPhysics(),
    itemCount: property.paymentRows.length,
    itemBuilder: (context, index) {
    return ListTile(
    title: Text('Amount: ${property.paymentRows[index]['amount']}'),
    subtitle: Text('Category: ${property.paymentRows[index]['category']}'),
    );
    },
    ),
    ),
    ListTile(
    title: Text('Possession Type: ${property.possessionType}'),
    ),
    ListTile(
    title: Text('Property Facing: ${property.propertyFacing.join(', ')}'),
    ),
    ListTile(
    title: Text('Property ID: ${property.propertyId}'),
    ),
    ListTile(
    title: Text('Property Owner: ${property.propertyOwner}'),
    ),
    ListTile(
    title: Text('Property Status: ${property.propertyStatus}'),
    ),
    ListTile(
    title: Text('Property Type: ${property.propertyType}'),
    ),
    ListTile(
    title: Text('Road Controller: ${property.roadController}'),
    ),
    ListTile(
    title: Text('Subcategory: ${property.subcategory}'),
    ),
      ListTile(
        title: Text('Super Buildup: ${property.superbuildup}'),
      ),
      ListTile(
        title: Text('Total Area: ${property.totalArea}'),
      ),
      ListTile(
        title: Text('UID: ${property.uid}'),
      ),
      ListTile(
        title: Text('Undivided Share: ${property.undividedShare}'),
      ),
      ListTile(
        title: Text('Videos:'),
        subtitle: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ListTile(
              title: Text('Video ${index + 1}: ${property.videos[index]}'),
            );
          },
        ),
      ),
      ListTile(
        title: Text('Years Old: ${property.yearsOld}'),
      ),
    ],
    ),
    );
  ...
  Future<PropertyModel> _fetchPropertyData(String propertyId) async {
    DocumentSnapshot documentSnapshot = await FirebaseFirestore.instance.collection('propert').doc(propertyId).get();
    return PropertyModel.fromFirestore(documentSnapshot);
  }
}